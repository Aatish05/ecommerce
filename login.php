...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!verify_csrf($_POST['csrf_token'] ?? null)) {
        ...
        if (!$user || !password_verify($_POST['password'] ?? '', $user['password_hash'])) {
            ...
            $errors['form'] = 'Your account is banned. Please contact admin.';
        } else {
            ...
            <div class="card shadow-sm">
                <div class="card-body p-4">
                    ...
                    <?php if (isset($errors['form'])): ?>
                        ...
                        <?php if ($errors['form'] === 'Your account is banned. Please contact admin.'): ?>
                            <script>
                                alert('Your account is banned. Please contact DGShop Team.');
                            </script>
                        <?php endif; ?>
                    <?php endif; ?>
                    ...
                    <p class="mt-3 mb-0">
                        Need an account? <a href="<?= url('register.php') ?>">Register now</a>.
                    </p>

                    <div class="alert alert-light border mt-3 small">
                        Demo accounts after importing the seed data:
