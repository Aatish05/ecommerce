    ...
    <div class="hero p-4 p-lg-5">
        <div class="row align-items-center g-5">
            <div class="col-lg-7">
                ...
                <p class="lead">EcoTech Electronics is a dynamic e-commerce website for curated laptops, phones, audio gear, and smart devices. It includes secure accounts, shopping cart, checkout, admin CRUD, search, and database-driven product pages.</p>
